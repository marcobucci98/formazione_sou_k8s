...
Il Jenkinsfile è stato strutturato per permettere di eseguire di eseguire lo script di build e push di un'immagine su Docker Hub tramite l'agent **jenkins-agent** :  
